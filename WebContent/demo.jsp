...
<head>
		...
		<section class="b-pageHeader">
			<div class="container">
				<h1 class="wow zoomInUp" data-wow-delay="0.7s">Listing Success</h1>
			</div>
		...
		<section class="b-error s-shadow">
			<div class="container">
				...
				<h2 class="s-lineDownCenter wow zoomInUp" data-wow-delay="0.7s">Listing Success</h2>
				<p class="wow zoomInUp" data-wow-delay="0.7s">Please Goto Profile For Review Your Listing.</p>
				<div class='s-submit'>
					<a href="profile"><button type="submit" class="btn m-btn pull-center wow zoomInUp" data-wow-delay="0.3s" style="margin-top:-100px;">Goto Profile<span class="fa fa-angle-right"></span></button></a>
				</div>
