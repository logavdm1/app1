				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-8 col-sm-7 col-xs-6">
						<div class="b-submit__main">
							...
							<spring:form class="s-submit clearfix" action="addlisting" method="POST" commandName="car">
							
								<div class="row">
									<div class="col-md-6 col-xs-12">
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											<label>Enter Car Status <span>*</span></label>
											<div class='s-relative'>
												<spring:select class="m-select" name="select1" path="car_status" required="true">
										...
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											...
											<div class='s-relative'>
												<spring:select class="m-select" name="select2" path="car_make" required="true">
													...
													<spring:option value="Mercedes">Mercedes</spring:option>
													<spring:option value="Aston">Aston</spring:option>
												</spring:select>
												<span class="fa fa-caret-down"></span>
											</div>
										</div>
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											...
											<div class='s-relative'>
												<spring:select class="m-select" name="select3" path="Passangers_Doors" required="true">
													...
													<spring:option value="8">8</spring:option>
										...
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											<label>Enter Kilometer <span>*</span></label>
											<div class='s-relative'>
												<spring:input  name="kilometers" path="Kilometres" required="true"/>
										...
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											...
											<div class='s-relative'>
												<spring:input path="Mileage" name="Mileage" required="true"/>
												
											</div>
										</div>
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											<label>Enter Exterior Color <span>*</span></label>
											<div class='s-relative'>
												<spring:input type="text" name="e_color" path="Exterior_Color" required="true"/>
												
											</div>
										</div>
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											<label>Enter Interior Color <span>*</span></label>
											<div class='s-relative'>
											
											<spring:input type="text" name="in_color" path="Interior_color" required="true"/>
												
											</div>
										</div>
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											<label>Enter Car Tumbnail Image URL <span>*</span></label>
											<div class='s-relative'>
											
											<spring:input  name="tumb_img" path="tumb_img" required="true"/>
									...
									<div class="col-md-6 col-xs-12">
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											...
											<div class='s-relative'>
												<spring:input type="text" name="car_model" path="car_model" required="true"/>
										...
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											...
											<div class='s-relative'>
												<spring:select class="m-select" name="select9" path="Body_Type" required="true">
													...
													<spring:option value="Convertible">Convertible</spring:option>
													<spring:option value="Sedan">Sedan</spring:option>
													<spring:option value="Minicar">Minicar</spring:option>
												</spring:select>
												<span class="fa fa-caret-down"></span>
											</div>
										</div>
										...
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											...
											<div class='s-relative'>
												<spring:select class="m-select" name="select11" path="Transmission" required="true">
													<spring:option value="Auto">Automatic</spring:option>
													<spring:option value="Manuel">Manuel</spring:option>
												</spring:select>
												<span class="fa fa-caret-down"></span>
											</div>
										</div>
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											...
											<div class='s-relative'>
												<spring:select class="m-select" name="select12" path="Engine" required="true">
										...
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											<label>Enter Estimated Price <span>*</span></label>
											<div class='s-relative'>
												<spring:input type="text" name="price" path="estimated_price" required="true"/>
												
											</div>
										</div>
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											<label>Enter Registration Year <span>*</span></label>
											<spring:input placeholder="Registration Year" type="text" name="input1" path="year_model" required="true"/>
										</div>
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											<label>Enter VIN/Chassis Number <span>*</span></label>
											<spring:input placeholder="Enter Number" type="text"  name="input2" path="" required="true"/>
										</div>
										<div class="b-submit__main-element wow zoomInUp" data-wow-delay="0.5s">
											<label>Enter Location <span>*</span></label>
											<spring:input placeholder="Enter Location" type="text"  name="input2" path="location" required="true"/>
										</div>
									</div>
								</div>
