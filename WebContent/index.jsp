...
background-color:#f5f5f5;
	...
	<body class="m-index" data-scrolling-animations="true" data-equal-height=".b-auto__main-item">
			...
			<div id="carousel" class="slide carousel carousel-fade">
				<div class="carousel-inner">
					<div class="item active">
						<img src="<c:url value="/resources/media/main-slider/1.jpg"></c:url>" alt="sliderImg" />
						<div class="container">
							<div class="carousel-caption b-slider__info">
								<h3>Find your dream Car</h3>
								<h2>SELL YOUR OLD CAR</h2>
								<p>JUST Advertist<span>Your Self</span></p>
								<a class="btn m-btn" href="addlisting">POST YOUR ADS<span class="fa fa-angle-right"></span></a>
							</div>
						</div>
					</div>
					<div class="item">
						<img src="<c:url value="/resources/media/main-slider/2.jpg"></c:url>" alt="sliderImg" />
						<div class="container">
							<div class="carousel-caption b-slider__info">
								<h3>Find your dream CAR</h3>
								<h2>Want To Buy Car</h2>
								<p>JUST SEARCH <span>AND FIND </span></p>
								<a class="btn m-btn" href="searchlist">Find Now<span class="fa fa-angle-right"></span></a>
							</div>
						</div>
					</div>
					<div class="item">
						<img src="<c:url value="/resources/media/main-slider/3.jpg"></c:url>"  alt="sliderImg"/>
						<div class="container">
							<div class="carousel-caption b-slider__info">
								<h3>Find your dream</h3>
								<h2>And Sell Your Car Also</h2>
								<p>By Just Single <span>Registration</span></p>
								<a class="btn m-btn" href="register">Register Here<span class="fa fa-angle-right"></span></a>
							</div>
						</div>
					</div>
				</div>
		...
		<section class="b-search">
			<div class="container">
				<spring:form action="searchlist" method="POST" class="b-search__main" commandName="searchobj">
					...
					<div class="b-search__main-type wow zoomInUp" data-wow-delay="0.3s">
						...
						<div class="col-xs-12 col-md-10">
							<div class="row">
								<div class="col-xs-2">
									<spring:radiobutton id="type1" path="car_type" name="type" value="Pickup"/>
								...
								<div class="col-xs-2">
									<spring:radiobutton id="type2" path="car_type" name="type" value="Suv"/>
								...
								<div class="col-xs-2">
									<spring:radiobutton id="type3" path="car_type" name="type" value="Coupe"/>
								...
								<div class="col-xs-2">
									<spring:radiobutton id="type4" path="car_type" name="type" value="Convertible"/>
								...
								<div class="col-xs-2">
									<spring:radiobutton id="type5" path="car_type" name="type" value="Sedan"/>
								...
								<div class="col-xs-2">
									<spring:radiobutton id="type6" path="car_type" name="type" value="Minicar"/>
						...
						<div class="row">
							<div class="col-xs-12 col-md-8">
								<div class="m-firstSelects">
									<div class="col-xs-4">
									<spring:select path="location" name="select1">
											
											<spring:option value="any" selected="">Any Location</spring:option>
											<spring:option value="Coimbatore" >Coimbatore</spring:option>
											<spring:option value="Coimbatore" >Chennai</spring:option>
											<spring:option value="Coimbatore" >Banglore</spring:option>
											<spring:option value="Coimbatore" >CMadurai</spring:option>
										
									</spring:select>
										
										<span class="fa fa-caret-down"></span>
										<p>select location ex:Chennai</p>
									</div>
									<div class="col-xs-4">
										<spring:select name="select2" path="car_status">
										<spring:option value="any" selected="">Vehicle Status</spring:option>
										<spring:option value="New" >New</spring:option>
										<spring:option value="Pre Owned" >Pre Owned</spring:option>
										</spring:select>
										<span class="fa fa-caret-down"></span>
										<p>Ex: New ,Pre Owned (OLD) </p>
									</div>
									<div class="col-xs-4">
										<spring:select name="select3" path="car_make">
											<spring:option value="any" selected="">Car Make</spring:option>
											...
											<spring:option value="porche" >Porche</spring:option>
										</spring:select>
										<span class="fa fa-caret-down"></span>
										<p>E.G:  Audi, BMW, JAGUAR</p>
									</div>
								</div>
								<div class="m-secondSelects">
									<div class="col-xs-4">
										<spring:select name="select4" path="car_engine_type">
											<spring:option value="any" selected="">Any Engine Type</spring:option>
							...
							<div class="col-md-4 col-xs-12 text-left s-noPadding">
								<div class="b-search__main-form-range">
									...
									<spring:hidden name="min" class="j-min" path="price_min" range="1000"/>
									<spring:hidden name="max" class="j-max" path="price_max" range="1000000"/>
								</div>
				...
				<spring:hidden path="car_id" value="${car.getCar_id()}"/>
					<div class="single_item">
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							<a>
							<!-- ${car.getTumb_img()} -->
								<img src="http://localhost:8080/Car_Dir_search/resources/media/186x113/aston.jpg" alt="mers" />
								
								<span class="b-items__cars-one-img-type m-listing">New</span>
							</a>
							<div class="b-featured__item-price">
								${car.getEstimated_price()}
							</div>
							<div class="clearfix"></div>
							<h5><a >${car.getCar_make()} ${car.getCar_model()}</a></h5>
							<div class="b-featured__item-count"><span class="fa fa-tachometer"></span>${car.getKilometres()}</div>
							<div class="b-featured__item-links">
								<a >${car.getCar_status()}</a>
								<a >${car.getYear_model()}</a>
								<a >${car.getTransmission()}</a>
								<a >${car.getInterior_color()}</a>
								<a >${car.getFuel_Type()}</a>
							</div>
						</div>
						<button type="submit" style="display:none;" name="singlecarbtn">Submit</button>
					</div>
