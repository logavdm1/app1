...
.col-md-4:hover
{
                ...
                <div class="col-lg-3 col-sm-4 col-xs-12">
                    <aside class="b-items__aside">
							...
							<div class="b-items__aside-main wow zoomInUp" data-wow-delay="0.5s">
								<spring:form action="userlistfilter" method="POST" commandName="searchcar">
								<spring:hidden path="user_id" value="${car.getCar_id()}"/>
                    ...
                    <c:forEach var="car" items="${cars}">
                        ...
                        <div class="b-items__cars-one wow zoomInUp" data-wow-delay="0.5s">
                            ...
                            <div class="b-items__cars-one-info">
                                    ...
                                    <h2>${car.getCar_make()} ${car.getCar_model()}</h2>
                                    ...
                                    <div class="col-md-3 col-xs-12">
                                        <div class="b-items__cars-one-info-price">
                                            <div class="pull-right">
                                                <h3>Price:</h3>
                                                <h4>${car.getEstimated_price()}</h4>
                                            </div>
                                            <a  class="btn m-btn">VIEW DETAILS<span class="fa fa-angle-right"></span></a>
  ...
  $(document).ready(function(){
     $(".b-items__cars-one.wow.zoomInUp").click(function(){
