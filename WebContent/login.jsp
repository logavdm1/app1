...
#frmpass
{
	...
	<body class="m-detail" data-scrolling-animations="true" data-equal-height=".b-auto__main-item">
		...
		<section class="b-pageHeader">
			<div class="container">
				<h1 class="wow zoomInLeft" data-wow-delay="0.5s">Login Page</h1>
			</div>
							...
							<aside class="b-detail__main-aside">
								...
								<div class="b-detail__main-aside-about wow zoomInUp" data-wow-delay="0.5s">
									...
									<div class="b-detail__main-aside-about-seller">
										<p>Please Provide : <span>Your Crendentials</span></p>
									</div>
									<div class="b-detail__main-aside-about-form">
										
										<spring:form method="post" action="login" commandName="user">
											<spring:input  placeholder="User Name" path="u_name"  required="true"/>
											<spring:password  placeholder="Password" path="u_pass" id="frmpass" required="true"/>
