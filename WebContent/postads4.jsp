						...
						<div class="b-submit__main">
								...
								<div class="b-submit__main-plan wow zoomInUp" data-wow-delay="0.3s">
									<header class="s-headerSubmit s-lineDownLeft">
										<h2>Verify You Entered Details</h2>
									</header>
																	
									
									<div class="row">
										<div class="col-xs-3">
											<h4 class="b-detail__main-aside-desc-title">Car Status</h4>
										</div>
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="car_status"/></p>
										</div>
										
										<div class="col-xs-3">
											<h4 class="b-detail__main-aside-desc-title">Car Make</h4>
										</div>
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="car_make"/></p>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xs-3">
											<h4 class="b-detail__main-aside-desc-title">Car Model</h4>
										</div>
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="car_model"/></p>
										</div>
										...
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="Kilometres"/></p>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xs-3">
											<h4 class="b-detail__main-aside-desc-title">Body_Type</h4>
										</div>
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="Body_Type"/></p>
										</div>
										...
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="Engine"/></p>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="Transmission"/></p>
										</div>
										...
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="Exterior_Color"/></p>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="Interior_color"/></p>
										</div>
										...
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="Passangers"/></p>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="Mileage"/></p>
										</div>
										...
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="location"/></p>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xs-3">
											<h4 class="b-detail__main-aside-desc-title">Year Model</h4>
										</div>
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="year_model"/></p>
										</div>
										
										<div class="col-xs-3">
											<h4 class="b-detail__main-aside-desc-title">Estimated Price</h4>
										</div>
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="estimated_price"/></p>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xs-3">
											<h4 class="b-detail__main-aside-desc-title">Tumb Img</h4>
										</div>
										<div class="col-xs-3">
											<p class="b-detail__main-aside-desc-value"><servion:getCarSessionValue  parameter="tumb_img"/></p>
										</div>
							...
							<spring:form action="addcartolist" cssClass="s-submit">
